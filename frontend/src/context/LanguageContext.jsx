...
const ES = {
  ...
  col_balance: 'Saldo', col_pay: 'Pago collab', col_m2: 'SF', col_invoices: 'Facturas',
...
const EN = {
  ...
  kpi_gross_margin: 'Gross Margin', kpi_collabs: 'Collaborators', kpi_m2: 'SF',
  ...
  salary_empty: 'No payroll payments pending',
  ...
  col_balance: 'Balance', col_pay: 'Collab pay', col_m2: 'SF', col_invoices: 'Invoices',
